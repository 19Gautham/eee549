...
def gd_algo(X_train, y_train, X_test, y_test, lam, step_size, max_iter):
    ...
    for i in range(max_iter):
        dW, dB = calc_gradient(w, b, X_train, y_train, lam)
    ...
    return train_loss_list, test_loss_list, train_err_list, test_err_list
...
if __name__ == "__main__":
    ...
    lamb = 0.1
    lr = 0.01
    train_loss_list, test_loss_list, train_err_list, test_err_list = gd_algo(
        X_train, y_train, X_test, y_test, lamb, lr, 1000)
    ...
    plt.title("Loss vs Iteration/Epoch")
    ...
    plt.title("Misclassification Error vs Epcoh/Iterations")
    plt.xlabel("Iteration/Epoch")
