...
def main_prgm():
    ...
    plt.scatter(samples1[:, 0], samples1[:, 1], alpha=0.15, label='Class 1')
    plt.scatter(samples2[:, 0], samples2[:, 1], alpha=0.15, label='Class -1')
    ...
    plt.ylabel('X2')
    plt.legend()
    plt.title('Logistic Regression Seperator vs. Bayes Optimal Separator')
    plt.show()
